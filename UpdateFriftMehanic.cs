...
//Это улучшеная версия скрипта управления(просто что бы показать что я розбираюсь XD)
...
public class CarController : MonoBehaviour
{
    ...
    async Task ChangeGear(int gearChange)
    {
        ...
        if (currentGear + gearChange >= 0)
        {
            ...
            await Task.Delay(TimeSpan.FromSeconds(changeGearTime));
